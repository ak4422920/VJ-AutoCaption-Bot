...
custom_caption = os.environ.get("custom_caption", "`{file_name}`\n\n**Powered By - @AKMOVIESHUBBACKUP**") # Here You Can Give Anything, if You Want Real File Name Then Use {file_name}
...
about_message = """
<b>• Name : <a href=https://t.me/The_SonGoku>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/akmoviebotz>[ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/AKMOVIESHUBBACKUP>Click Here</a></b>
<b>• Source Code : <a href=https://t.me/AKMOVIESHUBBACKUP>Click Here</a></b>"""
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/akmoviebotz"),
        pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
    ],[
        pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/Aichat_akbot{bot.username}?startchannel=true")
    ]]
...
print("Bot Created By @akmoviebotz")
